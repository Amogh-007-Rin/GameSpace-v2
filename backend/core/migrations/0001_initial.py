# Generated by Django 6.0.1 on 2026-01-12 07:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('GAMER', 'Gamer'), ('ADMIN', 'Admin')], default='GAMER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='threads', to='core.game')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PLAYING', 'Playing'), ('COMPLETED', 'Completed'), ('DROPPED', 'Dropped'), ('WISHLIST', 'Wishlist')], default='PLAYING', max_length=20)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'game'), name='unique_library_entry')],
            },
        ),
        migrations.CreateModel(
            name='Review',
