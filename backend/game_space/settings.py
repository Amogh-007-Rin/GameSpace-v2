...
DATABASES = {
    'default': {
        ...
        'NAME': 'game_space_db',      # The DB we just created
...
REST_FRAMEWORK = {
    # Use our Custom Renderer by default for all endpoints
    'DEFAULT_RENDERER_CLASSES': (
        'core.renderers.GameSpaceJSONRenderer',
        'rest_framework.renderers.BrowsableAPIRenderer', # Keeps the nice UI in browser
    ),
...
# 3. Middleware (Ensure this exists for Phase 6 Frontend connection)
